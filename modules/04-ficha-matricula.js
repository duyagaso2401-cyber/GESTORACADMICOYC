...
function pdfFichaMatricula(){
  ...
  // Header
  var escColFicha=db.escudoColombia||window._ESCUDO_COL_B64||(typeof ESCUDO_COLOMBIA!=='undefined'?ESCUDO_COLOMBIA:null);
  if(escColFicha){try{doc.addImage(escColFicha,'JPEG',ML,y,22,22);}catch(e){try{doc.addImage(escColFicha,'PNG',ML,y,22,22);}catch(e2){}}}
  if(db.logo&&db.logo.startsWith('data:')){try{doc.addImage(db.logo,'JPEG',PW-MR-22,y,22,22);}catch(e){}}
  ...
  // Pie de página con escudo Colombia al lado izquierdo ya colocado en encabezado
