function pdfFichaBlanco(){
  ...
  var y=12;
  // Header
  var _escColBlanco=db.escudoColombia||window._ESCUDO_COL_B64||(typeof ESCUDO_COLOMBIA!=='undefined'?ESCUDO_COLOMBIA:null);
  if(_escColBlanco){try{doc.addImage(_escColBlanco,'JPEG',ML,y,22,22);}catch(e){try{doc.addImage(_escColBlanco,'PNG',ML,y,22,22);}catch(e2){}}}
